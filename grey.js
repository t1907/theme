...
.clickable:hover{background-color: #969696}
...
.interface-element-border-window-frame, .battle-controller .graphics .battle-border, .additional-skill-panel .graphics .additional-skill-panel-border, .border-window{
  border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/window-frame.png) 32 20 fill repeat;
...
.interface-element-one-item-slot-background-to-repeat, .interface-element-item-slot-grid-stretch, .shop-wrapper .shop-content .shop-items.scrollable .scroll-pane{
  background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/oneItemSlotToRepeat.png)
}
...
.interface-element-vertical-wood{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/middle_graphics.png) repeat}

.interface-element-active-card-border-image, .interface-element-active-card-background-stretch{
  border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button.png) 5 fill repeat stretch
 }
.interface-element-active-card-background{
  background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button.png) no-repeat;
  background-size:100% 100%
  }

.interface-element-card-background, .interface-element-card-background-stretch{
  background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) no-repeat;
  background-size:100% 100%
}

.interface-element-wood-box-background{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/info-box-2.png);background-size:100% 100%}
...
.interface-element-middle-1-background, .interface-element-middle-2-background, .interface-element-middle-3-background, .interface-element-middle-4-background{
  border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/middle_graphics.png) 0 11 fill round;background: #101010
}

.interface-element-bottom-bar-background, .interface-element-bottom-bar-background-stretch{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/quest_bar.png) 0 20 fill stretch}

.interface-element-header-1-background{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/table_header.png) 0 20 fill stretch}
.interface-element-header-2-background{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/match-bar.png) 7 14 fill stretch}
...
.interface-element-table-3{color: #dcdcdc}
...
.interface-element-table-header-1-background{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/table_header.png);background-size:100% 100%}
...
.interface-element-header-1-background-stretch{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/table_header.png) 0 20 fill stretch}
.interface-element-header-2-background-stretch{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/match-bar.png) 7 14 fill stretch}
.interface-element-header-1{color: #dcdcdc}
...
.tabs-nav .card.active{pointer-events:none;background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button.png) no-repeat;background-size:100% 100%;color: #dcdcdc}

.drop-down-menu-section .content-wrapper .item-category-wrapper .drop-down-menu-item.selected{
  color: #dcdcdc;background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button.png) no-repeat;background-size:100% 100%
}

.depo .bottom-section .cards-menu .card:not(.disabled).active::before{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button.png) 17 20 fill repeat}
.matchmaking-ranking .ranking-tabs .cards-header .active{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button.png) no-repeat;background-size:100% 100%;color: #dcdcdc}
.cards-header-wrapper .cards-header .card.active{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button.png) no-repeat;background-size:100% 100%;color: #dcdcdc}

.tabs-nav .card{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) no-repeat;background-size:100% 100%;color: #dcdcdc}
.drop-down-menu-section .content-wrapper .item-category-wrapper .drop-down-menu-item{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) no-repeat;background-size:100% 100%}
.auction-off-item-panel input.default,.auction-window input.default{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) no-repeat;background-size:100% 100%;border:1px solid #808080;color: #dcdcdc}
.depo .bottom-section .cards-menu .card::before{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) 17 20 fill repeat}
.matchmaking-ranking .ranking-tabs .cards-header .card{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) no-repeat;background-size:100% 100%;color: #dcdcdc}
.cards-header-wrapper .cards-header .card{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) no-repeat;background-size:100% 100%;color: #dcdcdc}
.battle-pass-window .cards-header-wrapper .cards-header .card{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/width-card-button-active.png) no-repeat;background-size:100% 100%;color: #dcdcdc}

.search-wrapper{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/search.png) 5 9 23 34 fill}

.tabs-nav::before{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/friend-header.png) 11 13 fill stretch}
.mails-window .cards-header-wrapper .header-background-graphic{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/friend-header.png) 11 13 fill stretch}
.depo .bottom-section .cards-menu .cards-background{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/friend-header.png) 11 13 fill stretch}
.matchmaking-ranking .ranking-tabs .header-background-graphic{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/friend-header.png) 11 13 fill stretch}
.cards-header-wrapper .header-background-graphic{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/friend-header.png) 11 13 fill stretch}
.battle-pass-window .cards-header-wrapper .header-background-graphic{border-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/friend-header.png) 11 13 fill stretch}

.interface-layer {border: 7px solid transparent;border-image: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/oi7QxzB.png) 7 repeat !important;box-sizing: border-box;}
.layer.interface-layer .main-column.right-column{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/background.png) -251px 0}
.layer.interface-layer .main-column.right-column .border {background: transparent !important;}
.layer.interface-layer .main-column .extended-stats .border{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/background.png) -251px 0}
.layer.interface-layer .positioner.top .bg{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/gora.png) 0 -61px repeat}
.layer.interface-layer .positioner.bottom .bg{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/dol.png) 0 0 repeat}

.layer.interface-layer .positioner.top .hud-container {background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) -87px -109px}
.layer.interface-layer .positioner.top .hud-container .map_ball {background: url(https://i.imgur.com/y8yj4E7.png);}
.bottom-panel-of-bottom-positioner .bottom-panel-graphic {background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) no-repeat -256px -870px;}
.bottom-panel-of-bottom-positioner .exp-bar-wrapper .exp-progress .overlay {background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) no-repeat -450px -955px}
.bottom-panel-of-bottom-positioner .exp-bar-wrapper .exp-progress.right .overlay {background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) no-repeat -450px -976px}
.bottom-panel-pointer-bg .pointer-exp-graphic{background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) no-repeat -704px -953px}
.bottom-panel-pointer-bg .pointer-ttl-graphic{background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) no-repeat -777px -953px}
.bottom-panel-of-bottom-positioner .glass {background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) no-repeat -701px -1016px}
.clan-treasury-content .scroll-wrapper .scroll-pane .right-part .outfit-content {background: url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/buttony.png) no-repeat 0 -867px;}
...
.tw-list-item{background: #101010 !important; border-radius: 2px; box-shadow:0 0 0 1px rgba(255,255,255,.23) inset,0 0 0 1px rgba(0,0,0,.55);}
.tw-list-item:hover {
...
.border-window.transparent .search-wrapper{border-top:1px solid rgba(128,128,128,.5)}
...
.battle-pass-window .section .scroll-wrapper .scrollbar-wrapper .background{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/stats-scroll-bar.png) repeat;}
.promo-window .scrollbar-wrapper .background{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/stats-scroll-bar.png) repeat!important}
...
.conquer-stats .scroll-wrapper.classic-bar .scrollbar-wrapper .background{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/stats-scroll-bar.png) left 1px top repeat;}

.enhance__progress-bg{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) 0 -104px}
.enhance__progress--current, .enhance__progress--preview{background: rgb(200 200 200)}
.enhance__progress-text--preview{color: rgb(200 200 200)}
.battle-controller .time .time-inner{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) no-repeat -1px -47px}
.party .list .party-member .table-wrapper .hp .hp-bck{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) -331px -1px}
.party .list .party-member .table-wrapper .hp .hp-bar{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) -250px -1px}
.one-clan-quest .quest-progress-wrapper .clan-progress-bar{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) no-repeat 0 -81px}
.one-clan-quest .quest-progress-wrapper .clan-progress-bar .background-bar{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) 0 -92px}
.matchmaking-progress-stage .bar-and-item-side .progress-bar{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) -254px -136px}
.matchmaking-progress-stage .bar-and-item-side .progress-bar .background-bar{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/progressbary.png) -253px -147px}
...
.scroll-wrapper.small-bar .scrollbar-wrapper .arrow-down{background-image:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/chat-sprite.png)}

.drop-down-menu-section .type-header{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/header_left.png)}
...
.shop-wrapper .shop-background .paper-1,.shop-wrapper .shop-background .paper-2 {background: #101010; box-shadow: inset 0 0 5px 0 #808080;}
...
.world-window__info, .info-box, .salvage__info, .enhance__info, .extraction__info{border: 1px solid #808080 !important; background: #101010 !important; color: #dcdcdc}
...
.location-parameters__item,.server-parameters__item{border:1px solid #808080;color: #dcdcdc;}
.location-parameters__item:nth-child(odd),.server-parameters__item:nth-child(odd){background:rgba(16,16,16,.5)}
.location-parameters__item-value,.server-parameters__item-value{border-left:1px solid #808080;}
...
.hunting-statistics-table th,.hunting-statistics-table-header th{border:1px solid #808080;background: #101010;}
...
.salvage__label, .extraction__label, .enhance__label{border:1px solid #808080; box-shadow:none; color: #dcdcdc; background: #101010}

.additional-skill-panel{background:url(https://raw.githubusercontent.com/t1907/theme/refs/heads/main/gray/skill_hot_skills.png)}
...
.extended-stats .scroll-pane h3{border-bottom:1px solid #808080;color: #969696}
.extended-stats .scroll-pane .stat-group h4{color: #969696}
...
.one-item-on-divide-list .name-wrapper:hover{color: #dcdcdc}
...
.table-with-static-header .scroll-table-plug{background: #202020; border:1px solid #808080;}
...
.MBEditor .skills-list .single-skill-row.usable:nth-child(odd) {background: rgba(100, 100, 100, 0.25)} 
.MBEditor .skills-list .single-skill-row.usable .number {border-color: #808080}
.MBEditor .skills-list .single-skill-row.usable:hover {background: #323232}
...
.loot-window .items-wrapper .loot-item-wrapper .button-holder .button.green{border-color: #cccccc}
.loot-window .bottom-wrapper .table-wrapper .bag-left,.loot-window .bottom-wrapper .table-wrapper .time-left{color: #dcdcdc}

.ni-input input.default {border: 1px solid #808080;border-radius: 0;background: #202020;box-shadow: inset 0 0 1px 1px #202020;color: #dcdcdc;}
...
.popup-menu {
  box-shadow: 0 0 0 1px #2b2b2b inset, 0 0 0 1px #808080b0, 0 0 0 2px #2b2b2b;
  border-radius: 0;
...
.popup-menu .menu-item.menu-item--red {background: #8a001e;border-color: #ff003c;color: #dcdcdc;}
...
.popup-menu .menu-item.menu-item--debug {background: #8a001e;border-color: #aaaaaa;color: #dcdcdc;}
.popup-menu .menu-item.menu-item--debug:hover:not(.label):not(.disabled):not(.cooldown-disabled):not(.one-step-skill-menu) {background: #a00026;border-color: #aaaaaa;}
.popup-menu .menu-item.disabled,.popup-menu .menu-item.cooldown-disabled {background-color: #2f002f; color: #7a7a7a;border: 1px solid #555555;opacity: 0.7;}
...
.popup-menu .s_cost {border: 1px solid rgba(100, 100, 100, 0.3);border-radius: 0;background-color: rgba(100, 100, 100, 0.2);color: #b0b0b0;}
...
body:not(.mobile-version) .widget-button:not(.no-hover):not(.disabled):hover:not(.active){
  ...
  box-shadow:inset 0 0 1px 1px #cccccc,inset 0 0 0 3px #202020
}
...
@keyframes pulse {
  0% { box-shadow: 0 0 4px 4px rgba(255, 255, 255, 0.8); }
  50% { box-shadow: 0 0 10px 6px rgba(255, 255, 255, 0.6); }
  100% { box-shadow: 0 0 4px 4px rgba(255, 255, 255, 0.8); }
}
